...
contract BridgeOLD is Ownable, ITokenBridge {
    // struct Network {
    ...
    //     ) public 
    // {
    //     bytes32 eventHash = _getTokensBridgedEventHash(address(this), _receiver, _token, _amount, chainId, _salt);
        
    //     require(eventHash == _eventHash, "EVENT_NOT_SAME");
    //     require(_chainId == chainId, "Event must be targeted for this chain");
